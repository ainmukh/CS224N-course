...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        x = torch.index_select(self.embeddings, 0, w.view(-1)).view(w.size()[0], -1)
        # END YOUR CODE
        return x
    ...
    def forward(self, w):
        """ Run the model forward.
            ...
            Note that we will not apply the softmax function here
             because it is included in the loss function nn.CrossEntropyLoss
