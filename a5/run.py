...
Options:
    ...
    --use-char-decoder                      use the character decoder
"""
import math
import sys
import pickle
...
def train(args: Dict):
    ...
    model = NMT(word_embed_size=int(args['--word-embed-size']),
                ...
                vocab=vocab, use_char_decoder=args['--use-char-decoder'])
    model.train()
...
def decode(args: Dict[str, str]):
    ...
    model = NMT.load(args['MODEL_PATH'], no_char_decoder=args['--use-char-decoder'])
